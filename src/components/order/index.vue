              ...
              <div class="card-body custom-tab-1">
                <div class="tab-content">
                  <div id="my-posts" class="tab-pane fade active show">
                    <div
                      class="col-xl-12 col-xxl-12 col-lg-12 col-md-12 col-sm-12"
                    >
                      <div>
        ...
        <nav aria-label="...">
          <ul class="pagination pagination-lg pageh">
            <span class="page-item"
              ><span
                class="page-link"
                v-on:click="getOrderPage(currentPage - 1)"
                >Trang trước</span
              ></span
            >
            <li v-for="page in totalPages" :key="page">
              <span v-if="currentPage === page">
                <span class="page-item active"
                  ><span class="page-link" v-on:click="getOrderPage(page)">{{
                    page
                  }}</span></span
                >
              </span>
              <span v-else>
                <span class="page-item"
                  ><span
                    v-if="page <= 3 && page !== currentPage"
                    class="page-link"
                    v-on:click="getOrderPage(page)"
                    >{{ page }}</span
                  ></span
                >
                <span class="page-item"
                  ><span
                    v-if="totalPages > 20 && page % 20 === 0"
                    class="page-link"
                    v-on:click="getOrderPage(page)"
                    >{{ page }}</span
                  ></span
                >
                <span class="page-item"
                  ><span v-if="page === 4" class="page-link">...</span></span
                >
                <span class="page-item"
                  ><span
                    v-if="page >= totalPages - 1 && page !== currentPage"
                    class="page-link"
                    v-on:click="getOrderPage(page)"
                    >{{ page }}</span
                  ></span
...
export default {
  ...
  methods: {
    ...
    getOrderPage(page) {
      ...
      this.orders = this.orderAll.slice(

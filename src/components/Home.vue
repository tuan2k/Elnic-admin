    ...
    <div class="content-body">
      <div class="container-fluid">
        ...
        <div class="form-group">
          ...
          <select v-model="ty" v-on:change="selectType()" class="form-control">
            <option :value="t.id" v-for="t in type" :key="t.id">{{
              t.name
            }}</option>
          </select>
        </div>
        ...
        .then(({ data }) => {
          ...
          for (let i = 0; i < this.orders.length; i++) {
            ...
            if (this.nam === dt.getFullYear()) {
              if (dt.getMonth() === 1) {
                if (
                  this.orders[i].amount !== undefined &&
                  this.orders[i].amount !== NaN &&
            ...
            this.chart.push(obj1);
            this.chart.push(obj2);
            this.chart.push(obj3);
            this.chart.push(obj4);
            this.chart.push(obj5);
            this.chart.push(obj6);
            this.chart.push(obj7);
            this.chart.push(obj8);
            this.chart.push(obj9);
            this.chart.push(obj10);
            this.chart.push(obj11);
            this.chart.push(obj12);
          }
        })
        .catch();
    },
